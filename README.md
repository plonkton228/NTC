...
<p align="left">
  <ol>
    <li>Через панель упралвения имеется возможность добавлять услуги, удалять а также редактировать</li>
    <li>Через панель упралвения имеется возможность заполнять документы и удалять их а также редактировать</li>
    <li>Через панель упралвения имеется возможность добавлять партнеров и удалять их а также редактировать</li>
    <li>Через панель упралвения имеется возможность добавлять новости и удалять из а также редактировать</li>
  </ol>
</p>
<hr/>
