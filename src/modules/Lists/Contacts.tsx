         ...
         <div className= {ContactStyle.container}>
              <div style={{paddingLeft: "40px", paddingRight: "40px",paddingBottom: "40px"}}>
                  ...
                  <div className= {ContactStyle.innerContact}>
                     ...
                     <iframe src="https://yandex.ru/map-widget/v1/?um=constructor%3A5bddecf32a52e02cca42dea82cfc32d5f69136e35a26f0ad7117dcd3c7766e77&amp;source=constructor" width="540" height="516" ></iframe>
                     </div>
